...
/*MUTE / UNMUTE */
/* I want to mute the the audio immediately and unmute it again
Affordance - i want to toggle mute
...
/* REWIND (v): to go back, or to make something go back, to an earlier time */
/* I want to rewind the audio backward immediately after clicking, and do it as much time as i want
Affordance - i want to toggle rewind
Signifier - I want to press a button (double triangle points to the left)
Feedback - the audio turn back from the starting point
 */
...
/* fastFoward */
/* I want to forward the audio fast to the end immediately after clicking, and do it as much time as i want
Affordance - i want to toggle fast forward
Signifier - I want to press a button (double triangle points to the right)
...
clicking again, the command would be cancel */
/* I want to run the video, audio continously repeatedly after click it, and after i click it again it will run normally
(stop when the music is done)
Affordance - i want to toggle loop
Signifier - I want to press a button (arrow forming a circle, indicating looping)
Feedback - the audio restarts after reaching the end, and after clicking it again the audio will run and stop
at the ending point
 */
...
loopButton.addEventListener('click', loopingAudio)
/*the looping will turn on when people click this, which run the function 
addEventListener. Without this sentence, the code will run depend on the order of the
for example if we let 
" audioElement.loop= true;" first, the lopping will never happen
*/

/* fullScreen */
/* I want to make the graphic display (the hero image) is full, fill my whole screen immediatedly after clicking it. And after
click the button again, it will turn to an original size
Affordance -  the presence of a fullscreen icon to expand the hero image to fullscreen when clicked.
Signifier - I want to press a button
Feedback - the hero image is expanding
 */
...
/* document.querySelector: help you to find and grab specific elements on webpage */ 



muteButton.addEventListener('click', muteUnmute)
/* Everytime people press it then run the function 
addEventListener*/
